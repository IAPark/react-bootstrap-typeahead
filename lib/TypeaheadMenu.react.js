  ...
  function TypeaheadMenu() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TypeaheadMenu.__proto__ || Object.getPrototypeOf(TypeaheadMenu)).call.apply(_ref, [this].concat(args))), _this), _this._renderMenuItem = function (option, idx) {
      var _this$props = _this.props,
          ...
          renderNewOption = _this$props.renderNewOption;
      ...
      if (option.customOption) {
        return _react2.default.createElement(
          ...
          renderNewOption(option, _this.props, idx)
        );
      }
  ...
  _createClass(TypeaheadMenu, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          renderNewOption = _props.renderNewOption,
          text = _props.text,
          menuProps = _objectWithoutProperties(_props, ['labelKey', 'newSelectionPrefix', 'options', 'renderMenuItemChildren', 'renderNewOption', 'text']);
...
TypeaheadMenu.defaultProps = {
  ...
  renderNewOption: function renderNewOption(option, props, idx) {
    return _react2.default.createElement(
      'span',
      null,
